...
arrows, 14 shapes, landing page.

Next: multi-page table pagination, page-number element, data binding
(variables + CSV batch), npm publish, vector-text PDF. Details in [`plans/`](./plans).
